...
namespace PointAndRectangle
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        private void Draw()
        {
            ...
            {
                var ratioX = (pictureBoxRectangle.Width - 2 * offset - 1) / diagramWidth;
                var ratioY = (pictureBoxRectangle.Height - 2 * offset - 1) / diagramHeight;
            ...
            using (var g = Graphics.FromImage(pictureBoxRectangle.Image))
            {
